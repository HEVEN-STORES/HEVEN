    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t '>
      ...
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px] '>
        ...
        <div className='text-xl sm:text-2xl my-3'>
          ...
          <Title text1={'DELIIVERY'} text2={'INFORMATION'} />
        ...
        <input required onChange={onChangeHandler} name='email' value={formData.email} type="email" placeholder='Email Adderess' className='border border-gray-300 rounded py-1.5 px-3.5 w-full ' />
      ...
      <div className='mt-8'>
        ...
        <div className='mt-12'>
          ...
          <p className='text-sm text-red-500 mt-5'>* COD Not Available only <strong className='text-black font-bold'>Razorpay </strong>for  Payments ...</p>
