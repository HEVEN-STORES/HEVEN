...
//                 return (
//                   <div  key={index} className='py-4 border-t border-b text-gray-700 grid grid-cols-[4fr_0.5fr_0.5fr] sm:grid-cols-[4fr_0.2fr_0.5fr] items-center gap-4'>
            ...
            return (
              ...
              >
                ...
                <input
                  ...
                  disabled={!productData} // Disable input if product is unavailable
                />
